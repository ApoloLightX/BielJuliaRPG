    ...
    <div className="min-h-screen w-full bg-[#0e0b0a] text-[#e8ddd0] flex flex-col font-serif">
      ...
      {phase === "game" && (
        <>
          ...
          <nav className="flex border-b border-[#2a1f1a] bg-[#120e0c] overflow-x-auto" aria-label="Visões da campanha"><button type="button" onClick={() => setView("chat")} className={`min-w-[80px] flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs uppercase tracking-wider font-display ${view === "chat" ? "text-[#e8ddd0] border-b-2 border-[#b8492f]" : "text-[#8a7a6d]"}`}><MessageSquare size={13} /> Mesa</button><button type="button" onClick={() => setView("map")} className={`min-w-[80px] flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs uppercase tracking-wider font-display ${view === "map" ? "text-[#e8ddd0] border-b-2 border-[#b8492f]" : "text-[#8a7a6d]"}`}><MapIcon size={13} /> Mapa</button><button type="button" onClick={() => setView("sheet")} className={`min-w-[80px] flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs uppercase tracking-wider font-display ${view === "sheet" ? "text-[#e8ddd0] border-b-2 border-[#b8492f]" : "text-[#8a7a6d]"}`}><Backpack size={13} /> Fichas</button><button type="button" onClick={() => setView("journal")} className={`min-w-[80px] flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs uppercase tracking-wider font-display ${view === "journal" ? "text-[#e8ddd0] border-b-2 border-[#b8492f]" : "text-[#8a7a6d]"}`}><BookOpen size={13} /> Diário</button></nav>
