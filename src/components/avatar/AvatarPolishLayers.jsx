...
export function FacePolishLayer({ skinHex, hairHex, mark, accent }) {
  return (
    <g pointerEvents="none">
      ...
      <path d="M101 137 Q120 145 139 137" fill="none" stroke="#6f4434" strokeOpacity=".14" />
...
export function HairPolishLayer({ style, hairHex }) {
  ...
  const front = style === "short" ? "M91 80 Q101 57 120 55 Q140 57 151 78" : "M91 79 Q105 56 124 55 Q142 57 153 80";
  return (
    <g fill="none" stroke="#fff" strokeLinecap="round" pointerEvents="none">
      <path d={front} strokeOpacity=".13" strokeWidth="2.2" />
      ...
      {style === "braid" && <><path d="M157 104 Q168 126 158 145 Q168 163 158 184" strokeOpacity=".12" strokeWidth="1.5" /><path d="M153 114 L164 121 M154 134 L164 141 M154 154 L164 161 M154 174 L162 180" strokeOpacity=".09" strokeWidth="1.3" /></>}
      <path d={front} stroke={hairHex} strokeOpacity=".08" strokeWidth="5" />
    </g>
  );
}
